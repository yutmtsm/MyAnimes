                        ...
                        @foreach($following_Users as $following_User)
                            <div class="card">
                                <div class="card-header p-3 w-100 d-md-flex">
                                    @if($following_User->profile_image == null)
                ...
                <div id="followed" class="tab-pane fade">
                    @if (isset($followed_Users))
                        @foreach($followed_Users as $followed_User)
                            <div class="card">
                                <div class="card-header p-3 w-100 d-md-flex">
                                    @if($followed_User->profile_image == null)
                                    <img src="/images/noimage.png" class="rounded-circle" width="50" height="50">
                                    @else
                                    <img src="{{ asset('storage/profile_image/' .$followed_User->profile_image) }}" class="rounded-circle" width="50" height="50">
                                    @endif
                                    <div class="ml-2 d-flex flex-column">
